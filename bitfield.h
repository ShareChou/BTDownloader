...
int set_bit_value(Bitmap *bitmap, int index);	//设置某一位的值
...
int is_interested(Bitmap *dst, Bitmap *src);	//拥有位图src的peer是否对拥有dst位图的peer感兴趣
int get_download_piece_num();					//获取当前已下载到的总piece数量
#endif